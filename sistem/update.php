...
// }
    ...
    if ($validacao) {
        ...
        $sql = "UPDATE maquina  set nome = ?, telefone = ?, email = ?, local = ?, setor = ?, entrada = ?, saida = ?, tecnico = ?, status = ?, equip = ?, chapa = ?, chamado = ?, problema = ?, solucao = ?, modelo = ?, local2 = ?, recebe = ? WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $telefone, $email, $local, $setor, $entrada, $saida, $tecnico, $status, $equip, $chapa, $chamado, $problema, $solucao, $modelo, $local2, $recebe, $id));
        Banco::desconectar();
        header("Location: index.php");
    }
} else {
    ...
    $modelo = $data['modelo'];
    $recebe = $_SESSION['UsuarioNome'] . "-> Atualizado " . date('d/m/Y H:i') . " <\> " .$data['recebe'];
    ...
    <div class="container">
        ...
        <div class="span10 offset1">
                                ...
                                <div class="control-goup <?php !empty($setorErro) ? '$setorErro ' : ''; ?>">
                                    ...
                                    <div class="controls">
                                        <select class="form-control" name="setor" placeholder="setor"
                                            ...
                                            ?>
                                            <option selected value="DSMM - Dep de Sementes, Mudas e Matrizes">DSMM -
                                                Dep de Sementes, Mudas e Matrizes
                                            </option>
                                            <option value="EDR - Escritorio dev. Rural">EDR - Escritorio dev. Rural
                                            </option>
                                            <option value="CA - Casa de Agricultura">CA - Casa de Agricultura
                                            </option>
                                            <option value="NPM - Nucleo de Prod. de Mudas">NPM - Nucleo de Prod. de
                                                Mudas</option>
                                            <option value="APTA - Agência Paulista de Tec. dos Agronegocios">APTA -
                                                Agência Paulista de Tec. dos Agronegocios
                                            </option>
                                            <option value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            <option value="CATI - Coordenadoria de Desenvolvimento Rural Sustentavel">
                                                CATI - Coordenadoria de Desenvolvimento Rural Sustentável</option>
                                            <option value="CTIC - Centro de Tecnologia Informação e Comunicação">
                                                CTIC - Centro de Tecnologia Informação e Comunicação</option>
                                            <?php
                                            }
                                            ?>
                                            <?php
                                            ...
                                            <option selected value="EDR - Escritorio dev. Rural">EDR - Escritorio
                                                dev. Rural</option>
                                            <option value="CA - Casa de Agricultura">CA - Casa de Agricultura
                                            </option>
                                            <option value="NPM - Nucleo de Prod. de Mudas">NPM - Nucleo de Prod. de
                                            ...
                                            ?>
                                            <option value="DSMMM - Dep de Sementes, Mudas e Matrizes">DSMM - Dep de
                                                Sementes, Mudas e Matrizes</option>
                                            <option value="EDR - Escritorio dev. Rural">EDR - Escritorio dev. Rural
                                            </option>
                                            <option selected value="CA - Casa de Agricultura">CA - Casa de
                                                Agricultura</option>
                                            <option value="NPM - Nucleo de Prod. de Mudas">NPM - Nucleo de Prod. de
                                                Mudas</option>
                                            <option value="APTA - Agência Paulista de Tec. dos Agronegocio">APTA -
                                                Agência Paulista de Tec. dos Agronegocios</option>
                                            <option value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            <option value="CATI - Coordenadoria de Desenvolvimento Rural Sustentável">
                                                CATI - Coordenadoria de Desenvolvimento Rural Sustentável</option>
                                            ...
                                            <option selected value="NPM - Nucleo de Prod. de Mudas">NPM - Nucleo de
                                                Prod. de Mudas</option>
                                            <option value="APTA - Agência Paulista de Tec. dos Agronegocios">APTA -
                                                Agência Paulista de Tec. dos Agronegocios</option>
                                            <option value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            ...
                                            <option value="NPM - Nucleo de Prod. de Mudas">NPM - Nucleo de Prod. de
                                                Mudas</option>
                                            <option selected value="APTA - Agência Paulista de Tec. dos Agronegocios">
                                                APTA -
                                                Agência Paulista de Tec. dos Agronegocios</option>
                                            <option value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            ...
                                            <option value="APTA - Agência Paulista de Tec. dos Agronegocios">APTA -
                                                Agência Paulista de Tec. dos Agronegocios</option>
                                            <option selected value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            <option value="CATI - Coordenadoria de Desenvolvimento Rural Sustentável">
                                                CATI - Coordenadoria de Desenvolvimento Rural Sustentável</option>
                                            <option value="CTIC - Centro de Tecnologia Informação e Comunicação">
                                            ...
                                            <option value="CDA - Coordenadoria de Def. Agropecuaria">CDA -
                                                Coordenadoria de Def. Agropecuaria</option>
                                            <option selected
                                                value="CATI - Coordenadoria de Desenvolvimento Rural Sustentável">
                                                CATI - Coordenadoria de Desenvolvimento Rural Sustentável</option>
                                            <option value="CTIC - Centro de Tecnologia Informação e Comunicação">
                                                CTIC - Centro de Tecnologia Informação e Comunicação</option>
                                            <?php
            ...
            <input type="text" class="form-control" name="maquina['zip_code']">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="control-group  <?php echo !empty($recebeErro) ? 'error ' : ''; ?>">
                                    <label class="control-label">Atualização</label>
                                    <div class="controls">
                                        <input size="50" class="form-control" name="recebe" type="text" disabled="" 
                                            value="<?php echo !empty($recebe) ? $recebe : ''; ?> ">
                                        <?php if (!empty($recebeErro)) : ?>
                                        <span class="text-danger"><?php echo $recebeErro; ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
